...
public class TrueHealGetSettingTrueHealParticlesProcedure {
	public static boolean execute() {
		...
		boolean preheal_particles = false;
		truehealconfig = TrueHealGetConfigProcedure.execute();
		{
			try {
				...
				trueheal_particles = subObj.get("trueheal_particles").getAsBoolean();
			} catch (IOException e) {
				e.printStackTrace();
			}
		}
		return trueheal_particles;
	}
}